...
import tqdm
from SELeCT.Classifier.select_classifier import (
    get_dimension_weights
)
from SELeCT.Classifier.select_classifier import SELeCTClassifier
from SELeCT.Classifier.hoeffding_tree_shap import HoeffdingTreeSHAPClassifier
...
#%%
# fisher_cls = SELeCTClassifier(learner=HoeffdingTreeSHAPClassifier, feature_selection_method='fisher')
# fisher_cls = SELeCTClassifier(learner=HoeffdingTreeSHAPClassifier, feature_selection_method='default')
# fisher_cls = SELeCTClassifier(learner=HoeffdingTreeSHAPClassifier, feature_selection_method='histogram_MI', fingerprint_method = "histogram", fingerprint_bins=15)
# fisher_cls = SELeCTClassifier(learner=HoeffdingTreeSHAPClassifier, feature_selection_method='MIHy', fingerprint_method = "histogram", fingerprint_bins=15)
# fisher_cls = SELeCTClassifier(learner=HoeffdingTreeSHAPClassifier, feature_selection_method='MIHxCond', fingerprint_method = "histogram", fingerprint_bins=15)
# fisher_cls = SELeCTClassifier(learner=HoeffdingTreeSHAPClassifier, feature_selection_method='sketch_MI', fingerprint_method = "cachesketch", fingerprint_bins=100)
# fisher_cls = SELeCTClassifier(learner=HoeffdingTreeSHAPClassifier, feature_selection_method='CacheMIHy', fingerprint_method = "cache", fingerprint_bins=100)
# fisher_cls = SELeCTClassifier(learner=HoeffdingTreeSHAPClassifier, feature_selection_method='sketch_covMI', fingerprint_method = "cachesketch", fingerprint_bins=100)
fisher_cls = SELeCTClassifier(learner=HoeffdingTreeSHAPClassifier, feature_selection_method='sketch_covredMI', fingerprint_method = "cachesketch", fingerprint_bins=100)
...
# fisher_cls = SELeCTClassifier(learner=HoeffdingTreeSHAPClassifier, feature_selection_method='default')
# fisher_cls = SELeCTClassifier(learner=HoeffdingTreeSHAPClassifier, feature_selection_method='histogram_MI', fingerprint_method = "histogram", fingerprint_bins=15)
# fisher_cls = SELeCTClassifier(learner=HoeffdingTreeSHAPClassifier, feature_selection_method='MIHy', fingerprint_method = "cache", fingerprint_bins=10)
# fisher_cls = SELeCTClassifier(learner=HoeffdingTreeSHAPClassifier, feature_selection_method='CacheMIHy', fingerprint_method = "cache", fingerprint_bins=10)
fisher_cls = SELeCTClassifier(learner=HoeffdingTreeSHAPClassifier, feature_selection_method='CacheMIHy', fingerprint_method = "cache", fingerprint_bins=10)
fisher_cls2 = SELeCTClassifier(learner=HoeffdingTreeSHAPClassifier, feature_selection_method='sketch_MI', fingerprint_method = "cachesketch", fingerprint_bins=10)

# fisher_cls = SELeCTClassifier(learner=HoeffdingTreeSHAPClassifier, feature_selection_method='histogram_MI', fingerprint_method = "cachehistogram", fingerprint_bins=10)
# fisher_cls = SELeCTClassifier(learner=HoeffdingTreeSHAPClassifier, feature_selection_method='oldhistogram_MI', fingerprint_method = "cachehistogram", fingerprint_bins=10)
# fisher_cls = SELeCTClassifier(learner=HoeffdingTreeSHAPClassifier, feature_selection_method='Cachehistogram_MI', fingerprint_method = "cachehistogram", fingerprint_bins=10)
# fisher_cls2 = SELeCTClassifier(learner=HoeffdingTreeSHAPClassifier, feature_selection_method='Cachehistogram_MI', fingerprint_method = "cachehistogram", fingerprint_bins=50)
# fisher_cls2 = SELeCTClassifier(learner=HoeffdingTreeSHAPClassifier, feature_selection_method='histogram_MI', fingerprint_method = "cachehistogram", fingerprint_bins=10)
# fisher_cls = SELeCTClassifier(learner=HoeffdingTreeSHAPClassifier, feature_selection_method='MIHxCond', fingerprint_method = "histogram", fingerprint_bins=15)
monitor = []
monitor2 = []
force = True
