...
from SELeCT.utils.utils import tree_ensemble_init, SingleTree
import shap
import numpy as np
import scipy


def test_simple_BoundClassifier_same_res():
    ...
    cd_classifier = BoundClassifier(learner=learner, poisson=1)
...
test_simple_BoundClassifier_same_res()