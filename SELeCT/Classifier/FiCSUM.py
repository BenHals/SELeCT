...
from SELeCT.Classifier.metafeature_extraction import (window_to_timeseries,
                                                                  update_timeseries,
                                                                  get_concept_stats_from_base,
                                                                  get_concept_stats)
from SELeCT.Classifier.fingerprint import (FingerprintCache,
...
class FiCSUMClassifier:
    def __init__(self,
        ...
        self.min_window_size = int(window_size * min_window_ratio)
