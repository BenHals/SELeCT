...
class HyperplaneSampleGenerator(Stream):
    ...
    def __init__(self, random_state=None, sampler_random_state=None,
                 sampler_features = ['distribution', 'autocorrelation', 'frequency'], n_features=10, n_drift_features=2, mag_change=0.0,
                 noise_percentage=0.05, sigma_percentage=0.1, strength = 1):
        super().__init__()
